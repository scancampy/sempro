  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Penyesuaian Manual Status Sempro</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard'); ?>">Dashboard</a></li>
              <li class="breadcrumb-item active">Penyesuaian Manual Sempro</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <form class="form-horizontal" method="get" action="<?php echo current_url(); ?>">
              <div class="card card-primary ">
                ...
                <div class="card-footer">
                    <a href="<?php echo base_url('penyesuaian/statussempro'); ?>" class="btn btn-default">Reset</a>
            ...
            <div class="card card-primary">
              <div class="card-header">
                <div class="row">
                  <div class="col-12">
                    <h3 class="card-title">Data Sempro</h3>
  ...
  <div class="modal fade" id="modal-ubah-penguji-tampil">
      <div class="modal-dialog modal-lg ">
        <div class="modal-content">
          <form method="post" action="<?php echo base_url('penyesuaian/statussempro'); ?>">
          
          <div class="modal-header">
            <h4 class="modal-title">Ubah Penguji Sempro</h4>
            ...
            <div class="row">
              <div class="col-6">
                <p class="text-sm"><b>Nama</b>
                  ...
                  <input type="hidden" name="hid_sempro_ubah_penguji_id" id="hid_sempro_ubah_penguji_id"/>
                </p>
              </div>
              <div class="col-6">
  ...
  <div class="modal fade" id="modal-tampil">
      <div class="modal-dialog modal-lg ">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h4 class="modal-title">Penyesuaian Status Sempro</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
            ...
            <div class="row">
             <div class="col-6">
                <p class="text-sm"><b>Nama</b>
                  ...
                  <input type="hidden" name="hid_sempro_id" id="hid_sempro_id"/>
                </p>
              </div>
              <div class="col-6">
                <p class="text-sm"><b>NRP</b>
    ...
    right: 20px;" id="btn_hapus_sempro" name="btn_hapus_sempro" value="batal" onclick="return confirm('Yakin menghapus sempro ini?'); ">Hapus Pendaftaran Sempro</button>
                          ...
                          <div>
                            ...
                            <div class="timeline-item">
                              ...
                              <div class="timeline-body">
                                ...
                                <button class="btn btn-danger btn-xs" style="position: absolute;
    right: 20px;" id="btn_batal_validasi_kalab" name="btn_batal_validasi_kalab" value="batal" onclick="return confirm('Yakin batalkan status sempro ini?'); ">Batalkan</button>
                              </div>
                            </div>
                          </div>
                          <!-- end timeline -->
                          ...
                          <div>
                            ...
                            <div class="timeline-item">
                              ...
                              <div class="timeline-body">
                                ...
                                <button class="btn btn-danger btn-xs" style="position: absolute;
    right: 20px;" id="btn_batal_admin_plot_ruang" name="btn_batal_admin_plot_ruang" value="batal" onclick="return confirm('Yakin batalkan status sempro ini?'); ">Batalkan</button>
                              </div>
                            </div>
                          </div>
                          <!-- end timeline -->
                          ...
                          <!-- timeline item -->
                          <div>
                            <i id="dosbinginputhasilclock"></i>
                            <div class="timeline-item">
                              
                              <div class="timeline-body">
                                Dosbing - Input Hasil Ujian Sempro<br/>
                                <small id="div_dosbing_input_hasil_content"><i class="fas fa-clock"></i>
                                  <span id="tglinputhasil"></span>
                                </small>
                                <button class="btn btn-danger btn-xs" style="position: absolute;
    right: 20px;" id="btn_batal_dosbing_input_hasil" name="btn_batal_dosbing_input_hasil" value="batal" onclick="return confirm('Yakin batalkan status sempro ini?'); ">Batalkan</button>
                              </div>
                            </div>
                          </div>
                          <!-- end timeline -->
                          <!-- timeline item -->
                          <div id="top_div_mhs_revisi_naskah">
                            <i id="mhsrevisinaskahclock"></i>
                            <div class="timeline-item">
                              
                              <div class="timeline-body">
                                Mahasiswa - Revisi Naskah<br/>
                                <small id="div_mhs_revisi_naskah_content"><i class="fas fa-clock"></i>
                                  <span id="tglrevisinaskah"></span>
                                </small>
                                <button class="btn btn-danger btn-xs" style="position: absolute;
    right: 20px;" id="btn_batal_revisi_naskah" name="btn_batal_revisi_naskah" value="batal" onclick="return confirm('Yakin batalkan status sempro ini?'); ">Batalkan</button>
                              </div>
                            </div>
                          </div>
                          <!-- end timeline -->
                          ...
                          <!-- timeline item -->
                          <div id="top_div_dosen_validasi_revisi_naskah">
                            <i id="dosenvalidasirevisinaskahclock"></i>
                            <div class="timeline-item">
                              
                              <div class="timeline-body">
                                Dosbing - Validasi Revisi Naskah<br/>
                                <small id="div_dosen_validasi_revisi_naskah_content"><i class="fas fa-clock"></i>
                                  <span id="tglvalidasirevisinaskah"></span>
                                </small>
                                <button class="btn btn-danger btn-xs" style="position: absolute;
    right: 20px;" id="btn_batal_validasi_revisi_naskah" name="btn_batal_validasi_revisi_naskah" value="batal" onclick="return confirm('Yakin batalkan status sempro ini?'); ">Batalkan</button>
                              </div>
                            </div>
                          </div>
                          <!-- end timeline -->
