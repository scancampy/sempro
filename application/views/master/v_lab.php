            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-2">
                    <button type="button"  class="btn btn-block btn-primary btn-sm" data-toggle="modal" data-target="#modal-add">Tambah Lab</button>
                  </div>
                </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h4 class="modal-title">Tambah Data Lab Baru</h4>
          ...
          <div class="modal-body">
           <div class="form-group row">
            ...
            <div class="form-group row">
              <label for="namapendeknew" class="col-sm-4 col-form-label">Singkatan</label>
              <div class="col-sm-8">
                <input type="text" name="namapendeknew" class="form-control" id="namapendeknew" >
              </div>
            </div>
