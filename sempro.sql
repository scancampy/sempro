...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2023 at 05:32 AM
...
INSERT INTO `ijin_lab` (`id`, `periode_id`, `nrp`, `student_topik_id`, `submit_date`, `pembimbing_validated_npk`, `pembimbing_validated_date`, `kalab_validated_npk`, `kalab_validated_date`, `wd_validated_npk`, `wd_validated_date`, `is_deleted`) VALUES
(1, NULL, '110118199', 1, '2023-01-25 10:44:30', '199003', '2023-01-25 15:19:38', '201037', '2023-01-25 16:18:16', NULL, NULL, 0);
...
CREATE TABLE `user` (
  ...
  `user_type` enum('student','lecturer','staff','laboran','') NOT NULL,
...
('110118199', '$2y$10$rn2xTTEMqxZEVYh85ffAEeQQEbdTXOBVzSFXV5gSE.wcF17jdbAC6', 'student', '2023-02-14 20:46:40'),
...
('182018', '$2y$10$aYe.Du9UNxU4sHlzAencw.MWQXjmFqXZiFFfDGyNuwmu8CKx9mx7O', 'lecturer', '2023-02-14 21:28:19'),
...
('ajeng', '$2y$10$aYe.Du9UNxU4sHlzAencw.MWQXjmFqXZiFFfDGyNuwmu8CKx9mx7O', 'staff', '2023-02-14 21:28:08'),
...
CREATE TABLE `user_roles` (
  `id` int(11) NOT NULL,
  `username` varchar(30) NOT NULL,
  `roles` enum('admin','student','lecturer','kalab','wd','adminst','laboran') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
